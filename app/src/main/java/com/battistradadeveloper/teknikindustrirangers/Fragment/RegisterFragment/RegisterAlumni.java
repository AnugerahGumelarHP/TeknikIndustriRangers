...
public class RegisterAlumni extends Fragment {
	Button btnRegister;
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.fragment_register_alumni, container, false);
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		btnRegister = view.findViewById(R.id.btn_register_alumni);
